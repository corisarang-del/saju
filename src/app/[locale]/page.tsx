    ...
    <SajuLayout currentReading={currentReading}>
      ...
      <div className="bg-[radial-gradient(circle_at_top_left,#ede9fe_0,#f7f3ea_36%,#fffaf0_100%)]">
        <div className="mx-auto max-w-5xl px-4 pt-7 md:pt-8 [@media_(min-width:1024px)_and_(max-height:800px)]:pt-3">
          ...
          <h1 className="mt-3 max-w-[760px] text-balance text-[2rem] font-bold leading-[1.08] tracking-tight text-slate-950 md:text-[2.65rem] [@media_(min-width:1024px)_and_(max-height:800px)]:mt-2 [@media_(min-width:1024px)_and_(max-height:800px)]:text-[2.25rem]">
          ...
          <p className="mt-4 max-w-[680px] text-sm leading-6 text-slate-600 [@media_(min-width:1024px)_and_(max-height:800px)]:mt-2 [@media_(min-width:1024px)_and_(max-height:800px)]:leading-5">
