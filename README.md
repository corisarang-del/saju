...
**월간사주(월간사주)** 는 전통 동양 점술인 **사주팔자(四柱八字)** 를 현대 AI 기술과 결합한 오픈소스 프로젝트입니다.
...
이 프로젝트는 [FreAiner](https://fireship.me?utm_source=github&utm_medium=readme&utm_campaign=monthlysaju)가 만들었습니다.
...
**[부트캠프 자세히 보기 →](https://fireship.me/ko/bootcamp?utm_source=github&utm_medium=readme&utm_campaign=monthlysaju)**
...
**월간사주** is an open-source project that combines the traditional Eastern divination system **Saju Palja (Four Pillars of Destiny / 四柱八字)** with modern AI technology.
...
This project is built by [FreAiner](https://fireship.me?utm_source=github&utm_medium=readme&utm_campaign=monthlysaju), a solo developer who built 40+ AI services with Claude Code over the past year and monetized 3 of them.
...
**[Learn more →](https://fireship.me/ko/bootcamp?utm_source=github&utm_medium=readme&utm_campaign=monthlysaju)**
